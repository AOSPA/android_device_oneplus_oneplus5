...
# Perf
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perfconfigstore.xml:$(TARGET_COPY_OUT_SYSTEM)/product/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/etc/perf/perfconfigstore.xml \
    $(LOCAL_PATH)/configs/targetresourceconfigs.xml:$(TARGET_COPY_OUT_SYSTEM)/product/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/etc/perf/targetresourceconfigs.xml \
    $(LOCAL_PATH)/configs/perfboostsconfig.xml:$(TARGET_COPY_OUT_SYSTEM)/product/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/etc/perf/perfboostsconfig.xml
